...
if Mode:  # test mode
    ...
    hr, hi = load_data_prefect_csi(Mode)  # 1 means loading test 20000 samples
    ...
    hr, hi = load_data_prefect_csi(Mode)  # 0 means loading 150000 samples for training
    #hr, hi = load_data(1)  # 0 means loading 150000 samples for training
    sample_num, Nr = hr.shape  # numbers of samples and receive antennas
    model = bfnn_model()  # construct the BFNN model
